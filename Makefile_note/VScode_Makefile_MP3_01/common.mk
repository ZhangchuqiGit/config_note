...
CFLAGS += -g -Wall -std=c11 # make_debug
# CC = gcc

Sources = $(wildcard *.c) # 通配符会被自动展开
Objects = $(Sources:.c=.o) # bin 二进制文件
Depends = $(Sources:.c=.d) # header 二进制头文件

all: $(Depends) $(Objects) mp3
...
mp3:$(Objects)
ifdef Main
	$(CC) $(CFLAGS) -o $@ $^ ../lcd/lcd.o ../usb/usb.o ../media/media.o
endif
